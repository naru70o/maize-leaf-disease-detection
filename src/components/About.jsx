    ...
    <div className="bg-[linear-gradient(to_bottom,#6B8E23,#228B22)] py-[72px] overflow-clip text-white">
      <div className="container mx-auto px-4">
        <div className="flex flex-col">
          <h1 className="text-2xl text-center px-4 font-bold sm:text-3xl lg:text-5xl mx-auto">
            About our services
          </h1>
          <div className="flex flex-col gap-8 lg:flex-row-reverse mt-16 items-center">
            <p className="text-2xl font-medium text-center lg:text-start lg:text-star mt-9">
